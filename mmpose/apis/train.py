...
<<<<<<< HEAD
from ..datasets.datasets.top_down import TopDownCocoWholeBodyLazyDataset
from ..datasets.datasets.top_down import TopDownCocoWholeBodyLazyDataloader
...
def train_model(model,
    ...
    if isinstance(dataset[0], TopDownCocoWholeBodyLazyDataset):###################
